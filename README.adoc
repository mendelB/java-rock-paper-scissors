EDIT:
I changed the controller (which is in the `initial/src/main/java/hello` dir and added my own rock paper scissors class and logic.
...
🎮 To play visit `http://localhost:8080/rock-paper-scissors?play=` + `rock`, `paper`, or `scissors`.
